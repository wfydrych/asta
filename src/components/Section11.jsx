...
const Section11 = () => {
  return (
    <div className='section11'>
      <div className='section11__title'>WO KANN MAN MODULARE TREPPEN KAUFEN?</div>
      <div className='section11__content'>
        Wir wissen genau, wie wichtig Qualität und Ästhetik für unsere Kunden sind. Die langjährige Erfahrung und die ständige 
        technologische Entwicklung ermöglichen es uns, ein Design zu entwickeln, das den modernen Trends und den Anforderungen der Nutzer entspricht. 
        Fertige Metalltreppen sind eine Möglichkeit, eine einzigartige Innenwirkung zu erzielen. Nutzen Sie unser breites Angebot an Produkten.
        <br /><br />
        Warum sollten Sie sich für eine modulare Metalltreppe von ASTA entscheiden?
        <br /><br />
        ...
        <br /><br />
        Wenden Sie sich an einen Händler, der Ihnen bei der Auswahl einer auf Ihre Bedürfnisse und Raumbedingungen zugeschnittenen 
        Metalltreppe behilflich sein wird. Schließen Sie sich der Gruppe der zufriedenen Kunden an und entscheiden Sie sich jetzt für ASTA-Modultreppen.
        <br /><br />
      </div>
    </div>
  )
